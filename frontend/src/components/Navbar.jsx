            ...
            <div className='flex items-center gap-4'>
                {
                    ...
                    </div> : <button onClick={() => { navigate('/login');}} className='bg-primary text-white px-8 py-3 rounded-full font-light md:block '>Create Acount</button>
                }
                <img onClick={() => setShowMenu(true)} className='w-6 md:hidden cursor-pointer' src={assets.menu_icon}></img>
                {/* Mobile Menu */}

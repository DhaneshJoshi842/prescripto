            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='w-full lg:flext-1 flex-col gap-4'>
                            <div className='flex-1 flex-col gap-1'>
                                <p>Speciality</p>
                                <select className='border rounded px-3 py-2 ' onChange={(e) => setSpeciality(e.target.value)} value={speciality} >
                                    <option value='General Physician'>General Physician</option>
                                    <option value='Gynecologist'>Gynecologist</option>
                                    <option value='Dermatoligist'>Dermatologist</option>
                                    <option value='Pediactricians'>Pediactricians</option>
                            ...
                            <div className='flex-1 flex-col gap-1'>
                                <p>Education:</p>
                                <input onChange={(e) => setDegree(e.target.value)} className='border rounded px-3 py-2 ' value={degree} type='text' placeholder='Education' required></input>
                            </div>
                            <div className='flex-1 flex-col gap-1'>
                                <p>
                                    Address
                        ...
                        <div>
                            ...
                            <textarea onChange={(e) => setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 rounded' placeholder='Write about doctor' rows={5} required />
                        </div>
